...
Juan tenía tres manzanas, María tenía cinco manzanas, y Adán tenía seis manzanas. 
...
Imprimir las variables en una línea, y separar cada una de ellas con una coma;
...
realiza varias operaciones aritméticas con ellas (por ejemplo, +, -, *, /, //, etc.).

Intenta poner una cadena con un entero juntos en la misma línea, por ejemplo, 
