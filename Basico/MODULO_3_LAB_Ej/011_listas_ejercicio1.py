...
de la era del rock. De hecho, se incluyeron en la compilación de la revista Time de las 
100 personas más influyentes del siglo XX.

La banda sufrió muchos cambios de formación, que culminaron en 1962 con la formación de 
John Lennon, Paul McCartney, George Harrison y Richard Starkey 
...
beatles.append("Pual McCartney")
beatles.append("George Harrison")
print("Paso 2:", beatles)

# paso 3
integrantes = ["Stu Sutclieffe", "Pete Best"]
...
# paso 4
del beatles[4] #Hay que borrar el ultimo elemento
del beatles[3]
