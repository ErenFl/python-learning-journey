...
es una de las plantas para interiores más populares que filtra las toxinas dañinas del 
aire. Algunas de las toxinas que neutraliza incluyen benceno, formaldehído y amoníaco.
...
¡Y hazte de un Espatifilo también!
'''

planta = input(" ¿¡ESPANTIFILO!? ")
if planta == "ESPANTIFILO":
