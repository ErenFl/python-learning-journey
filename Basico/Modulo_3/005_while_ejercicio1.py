...
llamada secret_number. Quiere que todos los que ejecutan su programa jueguen el juego 
"Adivina el número secreto", y adivina qué número ha elegido para ellos. 
...
el usuario debería ver el mensaje "¡Ja, ja! ¡Estás atrapado en mi bucle!" y se le 
solicitará que ingrese un número nuevamente. 
...
while numero != secret_number:
    ...
    numero = int(input("¡Intentalo de nuevo! Ingresa otro numero entero\n"))
print("\nCorrecto! El número secreto era", "\"",numero,"\"")
